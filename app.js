...
window.addEventListener('load', async () => {
    try {
        ...
        // Initialize Solana connection with cluster config
        window.connection = new solanaWeb3.Connection(SOLANA_ENDPOINT, clusterConfig);
        ...
        // Initialize Token object from spl-token
        ...
        if (provider.isPhantom) {
            try {
                ...
                // Ignore connection errors for non-trusted apps
                console.log('Not previously connected:', e.message);
            }
        }
